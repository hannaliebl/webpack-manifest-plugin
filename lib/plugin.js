  ...
  compiler.plugin('emit', function(compilation, compileCallback) {
    ...
    _.merge(manifest, compilation.chunks.reduce(function(memo, chunk) {
      ...
      return chunk.files.reduce(function(memo, file) {
        ...
        if (this.getFileType(file) == 'css') {
          memo['assets/styles/' + chunkName + '.' + this.getFileType(file)] = file;
        }
        if (this.getFileType(file) == 'js')  {
          memo['assets/scripts/' + chunkName + '.' + this.getFileType(file)] = file;
        }
        if (chunkName) {
